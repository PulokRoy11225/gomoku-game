...
public class Server {
    ...
    private void initConfig() {
        try {
            // Load serverconfig.xml using relative path from the working directory
            String workingDirectory = System.getProperty("user.dir");
            String configFilePath = workingDirectory + File.separator + "serverconfig.xml";
            Map<String, String> info = Parser.parserServerConfig(configFilePath);
            ...
            LOG.debug("Server initialization completed with config: " + config);
        } catch (Exception e) {
            LOG.error("Failed to initialize server configuration", e);
        }
    }
}
